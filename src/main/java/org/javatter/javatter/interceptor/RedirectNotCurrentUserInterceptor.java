...
public class RedirectNotCurrentUserInterceptor extends HandlerInterceptorAdapter {
    @Autowired
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        // @ExcludeInterceptorアノテーションがついていないcontrollerメソッドはスキップ
        HandlerMethod handlerMethod = (HandlerMethod) handler;
        Method method = handlerMethod.getMethod();
        RedirectNotCurrentUser ann = AnnotationUtils.findAnnotation(method, RedirectNotCurrentUser.class);
        if (ann == null)
            return true;
