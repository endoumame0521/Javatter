...
public class InsertInitialData {
    ...
    public void insertUser() {
        createUser("aaaaaa", LocalDate.of(1940, 1, 1), "a@a", encodePassword("aaaaaa"), "大阪府", "はじめまして！宜しくお願い致します！",
                "http://sample1.com", "test1.jpg", "sample1.jpg");
        ...
        createUser("ffffff", LocalDate.of(1965, 6, 6), "f@f", encodePassword("ffffff"), "和歌山県", "こんにちは！今日もいい天気ですね！",
                "http://sample6.com", "test6.jpg", "sample6.jpg");
        ...
        createUser("hhhhhh", LocalDate.of(1975, 8, 8), "h@h", encodePassword("hhhhhh"), "岡山県", "なんで節分では鬼を追い払うかご存知ですか？",
                "http://sample8.com", "test8.jpg", "sample8.jpg");
        ...
        createUser("jjjjjj", LocalDate.of(1985, 10, 10), "j@j", encodePassword("jjjjjj"), "島根県",
                "海遊館では様々な海洋生物を見ることが出来ます！天保山へ遊びに来た際には是非お立ち寄りください！", "http://sample10.com", "test10.jpg", "sample10.jpg");
        createUser("kkkkkk", LocalDate.of(1990, 11, 11), "k@k", encodePassword("kkkkkk"), "広島県",
                "フェリーで北海道まで行けるってご存知でしたか？私は知らなかったです！いつか行ってみたいな！", "http://sample11.com", "test11.jpg", "sample11.jpg");
        createUser("llllll", LocalDate.of(1995, 12, 12), "l@l", encodePassword("llllll"), "徳島県",
                "また夜遊びをしていますね！ほんと良い歳なんだから程々にしてくださいよ！", "http://sample12.com", "test12.jpg", "sample12.jpg");
    }
